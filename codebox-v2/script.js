...
// Update line numbers
    ...
    htmlEditor.addEventListener('scroll', () => syncScroll(htmlEditor, htmlLineNumbers));
    cssEditor.addEventListener('scroll', () => syncScroll(cssEditor, cssLineNumbers));
    jsEditor.addEventListener('scroll', () => syncScroll(jsEditor, jsLineNumbers));
